...
import 'package:dreams/widgets/likeAnimation.dart';
...
class _PostCardState extends State<PostCard> {
                          ...
                          children: [
                            ...
                            (widget.snap['location'] != null)
                                ? IconButton(
                                    ...
                                    onPressed: () {
                                      double lat = (widget.snap['geoLatitude']
                                                  .toString() ==
                                              "")
                                          ? 0
                                          : widget.snap['geoLatitude'];
                                      double lon = (widget.snap['geoLongitude']
                                                  .toString() ==
                                              "")
                                          ? 0
                                          : widget.snap['geoLongitude'];
                            ...
                            IconButton(
                              ...
                              onPressed: () => showCallCustomDialog(
                                  context,
                                  '${widget.snap['contact']}',
                                  widget.snap['username'].toString()),
                              /*onPressed: () async {
  ...
  void showCallCustomDialog(
          BuildContext context, String contact, String username) =>
      showDialog(
        context: context,
        builder: (BuildContext context) => AlertDialog(
          title: const Text('Call Alert!'),
          content: (contact == 'null' || contact == '')
              ? const Text("This post has no contact number ")
              : Text('You need to call\n    $contact    $username'),
          actions: <Widget>[
            TextButton(
